...
vcom -93 -work work {C:/ap4-tp-fpga/TP2_ex1a2_flipflop_JKrs/TP2_ex1a2_flipflop_JKrs.vhd}

vcom -93 -work work {C:/ap4-tp-fpga/TP2_ex1a2_flipflop_JKrs/TP2_ex1a2_TB_flipflop_JKrs.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  TP2_ex1a2_TB_flipflop_JKrs
